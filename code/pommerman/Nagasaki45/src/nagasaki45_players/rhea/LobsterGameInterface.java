...
import nagasaki45_players.heuristics.*;
import nagasaki45_players.rhea.evo.Individual;
import nagasaki45_players.rhea.evo.Mutation;
import nagasaki45_players.rhea.hybrids.MCTSNode;
import nagasaki45_players.rhea.hybrids.LobsterMCTSNode;
...
import nagasaki45_players.rhea.utils.Utilities;
...
import static nagasaki45_players.rhea.utils.Constants.*;
import static nagasaki45_players.rhea.utils.Utilities.*;

public class LobsterGameInterface {
    ...
    LobsterGameInterface(RHEALobsterParams params, Random random, int playerID) {
        this.params = params;
        this.random = random;
    ...
    void initTick(GameState stateObs, ElapsedCpuTimer elapsedTimer) {
        ...
        fmBudget.reset();
        initStateInfo();
        stateHeuristic = new LobsterHeuristics(stateObs);
    }
    ...
    private double[][] seed_mcts() {
        ...
        LobsterMCTSNode m_root = new LobsterMCTSNode(random, nActions, actions, stateHeuristic, this);
