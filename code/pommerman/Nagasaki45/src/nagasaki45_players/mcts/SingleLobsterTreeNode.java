package nagasaki45_players.mcts;

import core.GameState;
import nagasaki45_players.heuristics.AdvancedHeuristic;
import nagasaki45_players.heuristics.CustomHeuristic;
import nagasaki45_players.heuristics.LobsterHeuristics;
...
public class SingleLobsterTreeNode
{
    ...
    {
        //To roll the state forward, we need to pass an action for *all* nagasaki45_players.
        int nPlayers = 4;
...
//                actionsAll[i] = Types.ACTIONS.ACTION_STOP;            //This is to assume the other nagasaki45_players would do nothing.
            }
        }
