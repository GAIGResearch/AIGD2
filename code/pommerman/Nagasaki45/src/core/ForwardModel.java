...
public class ForwardModel {
     ...
     * @param alive Indices of nagasaki45_players alive
     * @param game_mode Mode of game
     */
    ...
    void next(Types.ACTIONS[] playerActions) {
        ...
        // If bombs were bounced back, then they may overlap nagasaki45_players again, bounce nagasaki45_players back too if nagasaki45_players moved.
        for (GameObject b: bombs) {
            ...
            for (GameObject p: aliveAgents) {
                ...
                if (p.getDesiredCoordinate().equals(b.getDesiredCoordinate())) {
                    ...
                    if (((Avatar)p).canKick()) {
                        ...
                        // First bomb move on the same tick as the kick happened. Do not move into nagasaki45_players or walls.
    ...
    private void emptyBoard(){
        ...
        // Add nagasaki45_players in the corners
        addAgent(1, 1, 0);
    ...
    private void reduce(ForwardModel copy, int playerIdx) {
        ...
        // Reset flames life if playerIdx > -1, nagasaki45_players don't know this information
