...
class GameTest {
    ...
    /**
     * This method tests whether (in PO games) the pommerball_players only have access to the restricted info
     ...
     * by simulating random pommerball_players (taking little computation power, but some) going against each other
     */
    @Test
    void timePerTick(){
    ...
    void copyDeterminism() {
        ...
        //Assign pommerball_players and run the game.
        game.setPlayers(players);
        ...
        //Run a single game with the pommerball_players
     ...
     * If the replays are wrong, then it's not only because FM using pommerball_players screw with the game state of the real game.
     */
    @Test
    void determinismTickNoForwardModel() {
        ...
        //pommerball_players.add(new MCTSPlayer(seed, playerID++, mctsParams));
        //pommerball_players.add(new RHEAPlayer(seed, playerID++, rheaParams));
        //
        players.add(new SimplePlayer(seed, playerID++));
        players.add(new SimplePlayer(seed, playerID++));
        players.add(new SimplePlayer(seed, playerID++));
...
//        Run.runGames(game, new long[]{seed}, N, useSeparateThreads);
     ...
     * If the replay is right, then the pommerball_players most likely do not screw with the real model when using the FM.
     */
    @Test
    void determinismTickForwardModelUsed() {
        ...
        players.add(new SimplePlayer(seed, playerID++));
        players.add(new SimplePlayer(seed, playerID++));
        //pommerball_players.add(new SimplePlayer(seed, playerID++));
        //pommerball_players.add(new SimplePlayer(seed, playerID++));
