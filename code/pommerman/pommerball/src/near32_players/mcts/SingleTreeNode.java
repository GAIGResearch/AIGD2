package near32_players.mcts;

import core.GameState;
import near32_players.heuristics.AdvancedHeuristic;
import near32_players.heuristics.CustomHeuristic;
import near32_players.heuristics.OurHeuristic;
import near32_players.heuristics.StateHeuristic;
...
public class SingleTreeNode
{
    ...
    {
        //To roll the state forward, we need to pass an action for *all* near32_players.
        int nPlayers = 4;
...
//                actionsAll[i] = Types.ACTIONS.ACTION_STOP;            //This is to assume the other near32_players would do nothing.
            }
        }
