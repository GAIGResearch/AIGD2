package nagasaki45_players.rhea.evo;
...
public class LobsterEvolution {
    ...
    public LobsterEvolution(RHEALobsterParams params, Random random, LobsterGameInterface gInterface) {
        this.params = params;
        this.random = random;
