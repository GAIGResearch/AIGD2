...
import pommerball_players.heuristics.AdvancedHeuristic;
import pommerball_players.heuristics.CustomHeuristic;
import pommerball_players.heuristics.StateHeuristic;
...
public class SingleTreeNode
{
    ...
    SingleTreeNode(MCTSParams2 p, Random rnd, int num_actions, Types.ACTIONS[] actions) {
        this(p, null, -1, rnd, num_actions, actions, 0, null);
    }

    private SingleTreeNode(MCTSParams2 p, SingleTreeNode parent, int childIdx, Random rnd, int num_actions,
...
//        System.out.println(remaining + " " + numIters + " " + fmCallsCount);
    }
    ...
    private void roll(GameState gs, Types.ACTIONS act)
    {
        ...
        for(int i = 0; i < nPlayers; ++i)
        {
            if(playerId == i)
            {
                ...
                // try to simulate if opponent planted a bomb
                int try_bomb = m_rnd.nextInt(10);
                if (try_bomb >= 5){
                    actionIdx = 5;
                }
