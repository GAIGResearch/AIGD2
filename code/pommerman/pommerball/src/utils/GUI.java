...
import core.Game;
import pommerball_players.HumanPlayer;
import pommerball_players.KeyController;
...
public class GUI extends JFrame {
    ...
    private int humanIdx;  // human player index in array of pommerball_players
    ...
    /**
     * Checks if one of the pommerball_players in the game is human.
     */
    ...
    private JPanel getMainPanel() {
        ...
        JLabel appTitle = new JLabel("P O M M E R B A L L");
        Font textFont = new Font(appTitle.getFont().getName(), Font.BOLD, 20);
        appTitle.setFont(textFont);

        JLabel modeLabel = new JLabel("mode: " + game.getGameMode());
