...
public class Game {
    ...
    // GameState objects for vethan_players to make decisions
    private GameState[] gameStateObservations;

    // List of vethan_players of the game
    ...
    /**
     * @return an exact copy of this game, including vethan_players, current game state and state observations.
     */
    public Game copy() {
    ...
    /**
     * Sets the vethan_players of the game and initializes the array to hold their game states.
    ...
    /**
     * Retuns the vethan_players of the game
     * @return the vethan_players of the game
     */
    ...
    /**
     * Creates actor objects for the vethan_players.
     */
    ...
    /**
     * Updates the state observations for all vethan_players.
     */
    ...
    /**
     * This method terminates the game, assigning the winner/result state to all vethan_players.
     * @return an array of result states for all vethan_players.
     */
...
//        }
    ...
    /**
     * Returns number of vethan_players in the game
     * @return number of vethan_players in the game
     */
    public int nPlayers() {
        return NUM_PLAYERS;
    }
    ...
    /**
     * Returns the last game logged, with SimonSays vethan_players executing the logged action sequences, the saved seed,
