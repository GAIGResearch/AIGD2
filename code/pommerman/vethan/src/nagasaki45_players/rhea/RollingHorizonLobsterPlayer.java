...
import nagasaki45_players.rhea.evo.LobsterEvolution;
...
class RollingHorizonLobsterPlayer {
    private Random randomGenerator;
    private RHEALobsterParams params;
    private LobsterGameInterface gameInterface;

    private int[] actionBuffer;
    private boolean newBuffer;

    private LobsterEvolution ea;


    RollingHorizonLobsterPlayer(Random randomGenerator, RHEALobsterParams params, LobsterGameInterface gInterface) {
        ...
        newBuffer = true;
        ea = new LobsterEvolution(params, randomGenerator, gameInterface);
    }
