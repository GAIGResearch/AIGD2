...
import near32_players.SimonSaysPlayer;
import utils.GUI;
...
public class Game {
    ...
    // GameState objects for near32_players to make decisions
    private GameState[] gameStateObservations;

    // List of near32_players of the game
    ...
    /**
     * @return an exact copy of this game, including near32_players, current game state and state observations.
     */
    public Game copy() {
    ...
    /**
     * Sets the near32_players of the game and initializes the array to hold their game states.
    ...
    /**
     * Retuns the near32_players of the game
     * @return the near32_players of the game
     */
    ...
    /**
     * Creates actor objects for the near32_players.
     */
    ...
    /**
     * Updates the state observations for all near32_players.
     */
    ...
    /**
     * This method terminates the game, assigning the winner/result state to all near32_players.
     * @return an array of result states for all near32_players.
     */
...
//        }
    ...
    /**
     * Returns number of near32_players in the game
     * @return number of near32_players in the game
     */
    public int nPlayers() {
        return NUM_PLAYERS;
    }
    ...
    /**
     * Returns the last game logged, with SimonSays near32_players executing the logged action sequences, the saved seed,
