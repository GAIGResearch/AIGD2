...
public class SingleTreeNode
{
    ...
    {
        //To roll the state forward, we need to pass an action for *all* pommerball_players.
        int nPlayers = 4;
...
//                actionsAll[i] = Types.ACTIONS.ACTION_STOP;            //This is to assume the other pommerball_players would do nothing.
            }
        }
