package teamZero.spinbattle.controllers.singlePlayer.discountOLMCTS;
...
public class SingleTreeNode
{
    ...
    public double rollOut(StateObservation state)
    {
        ...
        while (!finishRollout(state,thisDepth)) {
            ...
            discount *= scoreDiscountFactor;

            totValue += discount * value(state);
    ...
    // need a way to discount the score
    public static double discountFactor = 0.95;
    public void backUpWithDiscount(SingleTreeNode node, double result)
    {
        SingleTreeNode n = node;
        while(n != null)
        {
